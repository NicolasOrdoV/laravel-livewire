{{-- <div>
    <x-card>
        ...
        <p class="my-4 ml-2">
            <span class="text-sm text-gray-500 italic font-bold uppercase tracking-widest">{{ $post->date }}</span>
            <span class="ml-4 rounded-md bg-purple-500 py-1 px-2 text-white">{{ $post->title }}</span>
